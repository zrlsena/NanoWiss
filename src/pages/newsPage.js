  ...
  return (
    <div>
      ...
      >
        <div
          style={{
            backgroundColor: "rgba(0, 0, 50, 0.7)", // Mavi tonlu opak katman
            width: "100%",
            height: "100%",
            position: "absolute",
            top: 0,
        ...
        <div style={{ position: "relative", zIndex: 2, textAlign: "left", }}>
          ...
          <h1 style={{fontSize:'50px', fontWeight:'500',marginTop:'40px', lineHeight:'1.1',}}>
        ...
        <div className="row g-4">
          ...
          <div className="col-md-4">
            <div className="card text-start">
              ...
              />
              <div className="card-body">
                <h5 className="card-title">12th International mRNA Health Conference</h5>
